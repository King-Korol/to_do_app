...
abstract class $BaseResponseCopyWith<T, $Res> {
  ...
  $Res call({String? error, String? message, T? data});
}
...
class __$$_BaseResponseCopyWithImpl<T, $Res>
  ...
  __$$_BaseResponseCopyWithImpl(
      ...
      : super(_value, (v) => _then(v as _$_BaseResponse<T>));

  @override
  _$_BaseResponse<T> get _value => super._value as _$_BaseResponse<T>;
...
class _$_BaseResponse<T> implements _BaseResponse<T> {
  const _$_BaseResponse({this.error, this.message, this.data});
...
abstract class _BaseResponse<T> implements BaseResponse<T> {
  const factory _BaseResponse(
      {final String? error,
      final String? message,
      final T? data}) = _$_BaseResponse<T>;
