...
import '../domain/tasks/use_cases/get_tasks_use_case.dart' as _i8;
import '../presentation/task_review/cubit/task_review_cubit.dart' as _i3;
import '../presentation/tasks/cubit/tasks_cubit.dart' as _i9;
...
_i1.GetIt $initGetIt(
  ...
  gh.factory<_i8.GetTasksUseCase>(
      () => _i8.GetTasksUseCase(tasksRepository: get<_i6.TasksRepository>()));
  gh.factory<_i9.TasksCubit>(
      () => _i9.TasksCubit(getTasksUseCase: get<_i8.GetTasksUseCase>()));
  return get;
}
